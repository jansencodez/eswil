    ...
    <div>
      <main className="bg-pink-50 flex flex-1 relative flex-col min-h-screen mx-1 mt-4">
        ...
        <section className="card">
          ...
          <p>
            We are set to help your children achieve greatness in their academia. We have a flexible system geared towards growing innovative and excellent minds. Our guided learning experience promotes holistic development amongst the young minds.
          </p>
          <section className="card">
            <h2>Welcome</h2>
            <p>
        ...
        <section className="card">
          ...
          <p>
            Our programmes are a best suite for your child. We offer a comprehensive curriculum that is up to date and synchronized with the new CBC programme.
          </p>
        </section>
        ...
        <section className="card bg-gray-200">
          ...
          <hr style={{ width: '100%', height: 2, backgroundColor: 'black' }} />
          <h2>Clubs</h2>
          <p>Our students are free to join clubs specific to their interests and passions. Below are some clubs available:</p>
          <hr style={{ width: '100%', height: 2, backgroundColor: 'black' }} />
          <section>
            <table>
              <thead>
